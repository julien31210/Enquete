...
// Cross Module References
	ENQUETE_API UClass* Z_Construct_UClass_AMyPawn_NoRegister();
	ENQUETE_API UClass* Z_Construct_UClass_AMyPawn();
	ENGINE_API UClass* Z_Construct_UClass_APawn();
	UPackage* Z_Construct_UPackage__Script_Enquete();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyPawn_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_Enquete,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyPawn, 3363580445);
	template<> ENQUETE_API UClass* StaticClass<AMyPawn>()
	{
		return AMyPawn::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyPawn(Z_Construct_UClass_AMyPawn, &AMyPawn::StaticClass, TEXT("/Script/Enquete"), TEXT("AMyPawn"), false, nullptr, nullptr, nullptr);
